// D1SM1_I_all with x_0=1, T=1, a=0.5, b=0.5, sigma=1
//Wait for TEST 
...
int main() {  
    ...
    const string csv_path = dir_path + "/D1SM1_I_all_100_1000_data.csv"; //data sourceのファイル名指定
       ...
       #pragma omp parallel reduction(+:S, Sm, S_1_5, Sb, B, Bm, B_1_5, Bb)
        {
            ...
            for (int p = 0; p < paths; ++p) {
                ...
                for (int idx = 1; idx < points; ++idx) {
                    ...
                    double sp_W_stateb = fabs(coefl.sigma_deriv);
