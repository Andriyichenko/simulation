// LTM2_check_var with x_0=1, T=1, z=0.5, a=-1, b=1,alpha=1.5
...
int main() {  
    ...
    constexpr double alpha=1.5;//alpha \in (0,2) 1 と　0.1（分散が小さいが、数値漏れる） と1.9（分散が大きい）
    // 定数の定義
    ...
    const string csv_path = dir_path + "/LTM2_check_var_100_1000_data.csv"; //data sourceのファイル名指定
